...
/
update KRIM_RSP_T set NM = 'CurriculumAdminReview' where RSP_ID = 308
/
update KRIM_RSP_T set NM = 'PresidentsOfficeReview' where RSP_ID = 309
/
update KRIM_RSP_T set NM = 'SystemOfficeReview' where RSP_ID = 310
/
