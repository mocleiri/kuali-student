...
INSERT INTO KSPR_PROPOSAL (PROPOSAL_ID, NAME, RATIONALE, DETAIL_DESC, EFF_DT, EXPIR_DT, TYPE, STATE, VER_NBR, CREATEID, CREATETIME) VALUES ('PROPOSAL-1', 'Change "De-Cal" to "Democracy at Cal"', 'Faculty senate officially recommended changing the titles rendering on the transcript from "De-Cal"', 'Change De-Cal to Democracy at Cal in the short name field of the official identifier.', {ts '2000-01-01 00:00:00.0'}, {ts '2000-12-31 00:00:00.0'}, 'proposalType.courseCorrection', 'active', 1, 'CREATEID1', {ts '2010-12-31 00:00:00.0'});
INSERT INTO KSPR_PROPOSAL (PROPOSAL_ID, NAME, RATIONALE, DETAIL_DESC, EFF_DT, EXPIR_DT, TYPE, STATE, VER_NBR, CREATEID, CREATETIME) VALUES ('PROPOSAL-2', 'Name 2', 'Rational 2', 'Detailed description 2', {ts '2000-01-01 00:00:00.0'}, {ts '2000-12-31 00:00:00.0'}, 'proposalType.courseCorrection', 'active', 1,  'CREATEID1',  {ts '2000-12-31 00:00:00.0'});
INSERT INTO KSPR_PROPOSAL (PROPOSAL_ID, NAME, RATIONALE, DETAIL_DESC, EFF_DT, EXPIR_DT, TYPE, STATE, VER_NBR, CREATEID, CREATETIME) VALUES ('PROPOSAL-3', 'Name 3', 'Rational 2', 'Detailed description 3', {ts '2000-01-01 00:00:00.0'}, {ts '2000-12-31 00:00:00.0'}, 'proposalType.newCourse', 'active', 1,  'CREATEID2',  {ts '2010-12-31 00:00:00.0'});
