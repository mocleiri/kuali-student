...
--
delete KSEN_TYPE 
where TYPE_KEY in ('kuali.org.Department', 'kuali.org.College')
/
...
replace (
replace (
replace (TYPE_KEY, 'kuali.org.AccreditingBody', 'kuali.org.type.accrediting.body'),
...
'kuali.org.PersonRelation.AdminAssistant', 'kuali.org.person.relation.type.admin.assistant'),
...
'kuali.org.hierarchy.academic.curriculum', 'kuali.org.hierarchy.type.academic.curriculum')
/
