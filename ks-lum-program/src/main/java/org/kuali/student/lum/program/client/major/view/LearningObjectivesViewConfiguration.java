...
public class LearningObjectivesViewConfiguration extends AbstractSectionConfiguration {
    ...
    public static LearningObjectivesViewConfiguration createSpecial() {
        ...
        return new LearningObjectivesViewConfiguration(new VerticalSectionView(ProgramSections.LEARNING_OBJECTIVES_VIEW, title, ProgramConstants.PROGRAM_MODEL_ID, new MajorEditableHeader(title, ProgramSections.LEARNING_OBJECTIVES_EDIT)));
    }
