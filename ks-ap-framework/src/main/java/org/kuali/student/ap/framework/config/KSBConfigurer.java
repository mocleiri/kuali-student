...
public class KSBConfigurer extends ModuleConfigurer implements SmartApplicationListener {
	...
	private static final String KSB_BOOTSTRAP_SPRING = "classpath:META-INF/ks-ap/ksb-bootstrap.xml";
	...
	public List<String> getPrimarySpringFiles(){
		...
		springFileLocations.add(KSB_BOOTSTRAP_SPRING);
		LOG.info("KSAP-26 KSB autowiring bootstrap " + KSB_BOOTSTRAP_SPRING);
