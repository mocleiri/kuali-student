...
import org.kuali.student.ap.plan.PlannerItem;
import org.kuali.student.ap.plan.PlannerTerm;
import org.kuali.student.ap.plan.PlannerTermNote;
		...
		if (terms == null) {
			...
			if (completedRecords != null)
				for (StudentCourseRecordInfo completedRecord : completedRecords) {
					String termId = completedRecord.getTermName();
					termIds.add(termId);
