...
(
      NMSPC_CD VARCHAR2(20)
        ...
        , APPL_ID VARCHAR2(20) default 'KUALI'
...
CREATE SEQUENCE KRIM_ROLE_PERM_ID_S INCREMENT BY 1 START WITH 1003 NOMAXVALUE NOCYCLE NOCACHE ORDER
/
...
DECLARE temp NUMBER;
BEGIN
	SELECT COUNT(*) INTO temp FROM user_sequences WHERE sequence_name = 'KRMS_CNTXT_TERM_SPEC_PREREQ_S';
	IF temp > 0 THEN EXECUTE IMMEDIATE 'DROP SEQUENCE KRMS_CNTXT_TERM_SPEC_PREREQ_S'; END IF;
END;
/
