...
Insert into KSSA_TRANSACTION_TYPE (TYPE,ID,SUB_CODE,CREATOR_ID,DEF_TRN_TXT,EDITOR_ID,END_DATE,LAST_UPDATE,START_DATE,AUTH_TXT,CLEAR_PERIOD,REFUND_RULE,PRIORITY,DEF_ROLLUP_ID_FK) values ('C','DEF',1,'pheald','DEFERMENT TYPE',null,null,to_timestamp('29-MAR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('29-MAR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),null,null,null,1,3);
...
Insert into KSSA_POSTAL_ADDRESS (ID,COUNTRY_CODE,CREATOR_ID,IS_DEFAULT,EDITOR_ID,KIM_ADDRESS_TYPE,LAST_UPDATE,POSTAL_CODE,STATE_CODE,CITY,LINE1,LINE2,LINE3,ACNT_ID_FK) values (4,'USA','pheald','N',null,null,to_timestamp('02-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'00093','RI','Qahog','28 Spooner Street','C/O Mr. Glenn Quagmire',null,'user3');
