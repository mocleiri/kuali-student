...
Insert into KSSA_TRANSACTION_TYPE (TYPE,ID,SUB_CODE,CREATOR_ID,DEF_TRN_TXT,EDITOR_ID,END_DATE,LAST_UPDATE,START_DATE,AUTH_TXT,CLEAR_PERIOD,REFUND_RULE,PRIORITY,DEF_ROLLUP_ID_FK) values ('D','1298',1,'pheald','MARYLAND IN BARCELONA',null,null,to_timestamp('29-MAR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),to_timestamp('29-MAR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),null,null,null,1,3);
