--------------------------------------------------------
--  File created - Tuesday-April-03-2012   
--------------------------------------------------------
...
Insert into KSSA_TRANSACTION (TYPE,ID,ALLOCATED,AMNT,EFFECTIVE_DATE,EXTN_ID,GL_ENTRY_GENERATED,IS_INTERNAL_TRN,LEDGER_DATE,LOCKED_ALLOCATED,NATIVE_AMNT,ORIG_DATE,RESP_ENTITY,STATEMENT_TXT,CLEAR_DATE,DEFER_ID,EXPIRATION_DATE,ACNT_ID_FK,CURRENCY_ID_FK,DOCUMENT_ID_FK,ROLLUP_ID_FK,TRANSACTION_TYPE_ID_FK,TRANSACTION_TYPE_SUB_CODE_FK) values ('TDC',1,null,10000,to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'FA-10200291','N','N',to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),null,10000,to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'pheald','Tuition',null,null,null,'1',1,null,3,'1020',1);
Insert into KSSA_TRANSACTION (TYPE,ID,ALLOCATED,AMNT,EFFECTIVE_DATE,EXTN_ID,GL_ENTRY_GENERATED,IS_INTERNAL_TRN,LEDGER_DATE,LOCKED_ALLOCATED,NATIVE_AMNT,ORIG_DATE,RESP_ENTITY,STATEMENT_TXT,CLEAR_DATE,DEFER_ID,EXPIRATION_DATE,ACNT_ID_FK,CURRENCY_ID_FK,DOCUMENT_ID_FK,ROLLUP_ID_FK,TRANSACTION_TYPE_ID_FK,TRANSACTION_TYPE_SUB_CODE_FK) values ('TDC',2,null,10000,to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'FA-10029919','N','N',to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),null,10000,to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'pheald','Tuition',null,null,null,'2',1,null,3,'1020',1);
Insert into KSSA_TRANSACTION (TYPE,ID,ALLOCATED,AMNT,EFFECTIVE_DATE,EXTN_ID,GL_ENTRY_GENERATED,IS_INTERNAL_TRN,LEDGER_DATE,LOCKED_ALLOCATED,NATIVE_AMNT,ORIG_DATE,RESP_ENTITY,STATEMENT_TXT,CLEAR_DATE,DEFER_ID,EXPIRATION_DATE,ACNT_ID_FK,CURRENCY_ID_FK,DOCUMENT_ID_FK,ROLLUP_ID_FK,TRANSACTION_TYPE_ID_FK,TRANSACTION_TYPE_SUB_CODE_FK) values ('TDC',4,null,2000,to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'FA-01299101','N','N',to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),null,2000,to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'pheald','Mandatory Fee',null,null,null,'3',1,null,3,'1001',1);
Insert into KSSA_TRANSACTION (TYPE,ID,ALLOCATED,AMNT,EFFECTIVE_DATE,EXTN_ID,GL_ENTRY_GENERATED,IS_INTERNAL_TRN,LEDGER_DATE,LOCKED_ALLOCATED,NATIVE_AMNT,ORIG_DATE,RESP_ENTITY,STATEMENT_TXT,CLEAR_DATE,DEFER_ID,EXPIRATION_DATE,ACNT_ID_FK,CURRENCY_ID_FK,DOCUMENT_ID_FK,ROLLUP_ID_FK,TRANSACTION_TYPE_ID_FK,TRANSACTION_TYPE_SUB_CODE_FK) values ('TDC',3,null,15000,to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'FA-10200222','N','N',to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),null,15000,to_timestamp('03-APR-12 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'pheald','Tuition',null,null,null,'3',1,null,3,'1020',1);
