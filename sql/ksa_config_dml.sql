...
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('NAME_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('ADDRESS_SEQ', 1001);
...
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('FAILED_GL_TRANSACTION_SEQ', 1001);
...
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('KEY_PAIR_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('ACCESS_LEVEL_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('ACNT_TYPE_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('ACNT_AUTHZ_SEQ', 1001);
...
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('TP_PLAN_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('TP_PLAN_MEMBER_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('TP_TRANSFER_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('PB_PLAN_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('PB_DATE_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('PB_TRANSFER_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('PB_TRANSACTION_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('PB_SCHEDULE_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('PB_ALLOWABLE_CHARGE_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('PB_QUEUE_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('FM_SESSION_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('FM_SIGNUP_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('FM_SIGNUP_RATE_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('FM_SIGNUP_RATE_AMOUNT_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('FM_MANIFEST_SEQ', 1001);
insert into KSSA_SEQUENCE_TABLE (SEQ_NAME, SEQ_VALUE) values ('FM_SESSION_LOG_SEQ', 1001);
