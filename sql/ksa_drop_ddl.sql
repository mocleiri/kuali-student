...
drop table KSA.KSSA_KEYPAIR cascade constraints;
drop table KSA.KSSA_LANGUAGE cascade constraints;
drop table KSA.KSSA_LATE_PERIOD cascade constraints;
drop table KSA.KSSA_LEARNING_UNIT cascade constraints;
drop table KSA.KSSA_L_UNIT_PERIOD_KEYPAIR cascade constraints;
drop table KSA.KSSA_PERIOD_PERIOD_KEYPAIR cascade constraints;
...
drop table KSA.KSSA_STUDENT_KEYPAIR cascade constraints;
