...
alter table KSA.KSSA_GL_TRANS_TRANSACTION add constraint FK3419698CD61AFDF9 foreign key (TRANSACTION_ID_FK) references KSA.KSSA_TRANSACTION;
alter table KSA.KSSA_GL_TRANS_TRANSACTION add constraint FK3419698CC852663A foreign key (GL_TRANSACTION_ID_FK) references KSA.KSSA_GL_TRANSACTION;
