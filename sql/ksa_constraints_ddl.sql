...
alter table KSA.CASH_LIMIT_EVENT_TRANS add constraint FKEF56CBD3D61AFDF9 foreign key (TRANSACTION_ID_FK) references KSA.KSSA_TRANSACTION;
alter table KSA.CASH_LIMIT_EVENT_TRANS add constraint FKEF56CBD3E0CEA4F3 foreign key (CASH_LIMIT_EVENT_ID_FK) references KSA.KSSA_CASH_LIMIT_EVENT;
...
alter table KSA.KSSA_CASH_LIMIT_PARAMETER add constraint FKEA9B9DC247AB5D71 foreign key (TAG_ID_FK) references KSA.KSSA_TAG;
alter table KSA.KSSA_CASH_LIMIT_SUM_ELEMENT add constraint FK319368C1E0CEA4F3 foreign key (CASH_LIMIT_EVENT_ID_FK) references KSA.KSSA_CASH_LIMIT_EVENT;
