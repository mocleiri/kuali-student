...
alter table KSSA_ACNT_KEY_PAIR add constraint FKEE542B08C9ADF350 foreign key (KEY_PAIR_ID_FK) references KSSA_KEY_PAIR;
alter table KSSA_ACNT_KEY_PAIR add constraint FKEE542B0898518DD2 foreign key (ACNT_ID_FK) references KSSA_ACNT;
...
alter table KSSA_FM_MANIFEST add constraint FK496D0D9EB1D17704 foreign key (RATE_ID_FK) references KSSA_RATE;
alter table KSSA_FM_MANIFEST_KEY_PAIR add constraint FKD4F0165BC9ADF350 foreign key (KEY_PAIR_ID_FK) references KSSA_KEY_PAIR;
...
alter table KSSA_FM_SESSION_KEY_PAIR add constraint FKC36398F2C9ADF350 foreign key (KEY_PAIR_ID_FK) references KSSA_KEY_PAIR;
...
alter table KSSA_FM_SESSION_LOG add constraint FK9BCA600C32EC13CF foreign key (FM_SESSION_ID_FK) references KSSA_FM_SESSION;
...
alter table KSSA_RATE_CATALOG_KEY_PAIR add constraint FKF1AE7616C9ADF350 foreign key (KEY_PAIR_ID_FK) references KSSA_KEY_PAIR;
alter table KSSA_RATE_KEY_PAIR add constraint FKE2B2DE90BEC5B88F foreign key (RATE_KEY_PAIR_ID_FK) references KSSA_KEY_PAIR;
