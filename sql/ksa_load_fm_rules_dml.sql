...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Regular signup add before first day of class.', 5001, 'FM Signup 1_01', 3, 20, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Regular signup awop or transfer.', 5002, 'FM Signup 1_02', 3, 20, null,
'(signup operation is "ADD_WITHOUT_PENALTY,TRANSFER_IN")',
'set session key "early.registration" to "true"
 mark signup as taken
')!

Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Legal drop due to dwop or transfer', 5003, 'FM Signup 1_03', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('withdrawal at 80 percent', 5004, 'FM Signup 1_04', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('withdrawal at 60 percent', 5005, 'FM Signup 1_05', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('withdrawal at 40 percent', 5006, 'FM Signup 1_06', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('withdrawal at 20 percent', 5007, 'FM Signup 1_07', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('withdrawal at 0 percent', 5008, 'FM Signup 1_08', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Legal drop before first day of class', 5009, 'FM Signup 1_09', 3, 10, null,
...
'(signup has rates "mba.cohort.flag" and signup has rates "regular" and session key "cohort.code" is "em.." and session key "major.code" is ".*mba")',
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Late fee charge', 6001, 'FM Session 1_01', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('UG student has more than 12 units so is full time', 6002, 'FM Session 1_02', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Grad student has over 9 units so is full time', 6003, 'FM Session 1_03', 3, 10, null,
'(number of taken units gte 9 with rates "", types "", signup operations "" and student is graduate)',
'set session key "study.load" to "ft"')!

Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Doctoral student has over 9 units so is full time', 6004, 'FM Session 1_04', 3, 10, null,
'(number of taken units gte 9 with rates "", types "", signup operations "" and session key "study.level" is "doctoral")',
'set session key "study.load" to "ft"')!

Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('UG student is under 12 units so is part time', 6005, 'FM Session 1_05', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Grad student is under 9 unis so is part time', 6006, 'FM Session 1_06', 3, 10, null,
'(number of taken units lt 9 with rates "", types "", signup operations "" and student is graduate)',
'set session key "study.load" to "pt"')!

Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Doctoral student is under 9 units so is part time', 6007, 'FM Session 1_07', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Remove mandatory fees for all Collaborative Engineering Student', 6009, 'FM Session 1_09', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student has ENGF major so gets enpm tuition rates', 6050, 'FM Session 2_01', 3, 8, null,
'(session key "major.code" is "engf")',
'replace signup rates "regular", "" with "enpm", "default"')!

Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is undergrad full time resident so is charged those tuition rates - CP.', 6051, 'FM Session 2_02', 3, 8, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is grad full time resident so is charged those tuition rates - CP.', 6052, 'FM Session 2_03', 3, 8, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is undergrad full time nonresident so is charged those tuition rates - CP.', 6053, 'FM Session 2_04', 3, 8, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is grad full time nonresident so is charged those tuition rates - CP.', 6054, 'FM Session 2_05', 3, 8, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is undergrad part-time resident so is charged those tuition rates - CP.', 6055, 'FM Session 2_06', 3, 8, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is grad part-time resident so is charged those tuition rates - CP.', 6056, 'FM Session 2_07', 3, 8, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is undergrad part-time nonresident so is charged those tuition rates - CP.', 6057, 'FM Session 2_08', 3, 8, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is grad part-time nonresident so is charged those tuition rates - CP.', 6058, 'FM Session 2_09', 3, 8, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Academic service fee is to be removed', 7001, 'FM Signup 2_01', 3, 10, null,
'(signup is taken and signup does not have rates "academic.service.fee")',
'set session key "academic.service.remove" to "y"')!

Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is SG and incurs SG reg fee', 7002, 'FM Signup 2_02', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is SG and incurs SG reg fee', 7003, 'FM Signup 2_03', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is SG and incurs SG reg fee', 7004, 'FM Signup 2_04', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Student is SG and incurs SG reg fee', 7005, 'FM Signup 2_05', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Frostburg student receives discount major 0909F', 7006, 'FM Signup 2_06', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Frostburg student receives discount major 0909F', 7007, 'FM Signup 2_07', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Frostburg student receives discount major 0909F', 7008, 'FM Signup 2_08', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Frostburg student receives discount major 0909F', 7009, 'FM Signup 2_09', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop does not affect calculation so is ignored', 7040, 'FM Signup 3_01', 3, 5, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop does not affect calculation so is ignored', 7041, 'FM Signup 3_02', 3, 5, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop does not affect calculation so is ignored', 7042, 'FM Signup 3_03', 3, 5, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop does not affect calculation so is ignored', 7043, 'FM Signup 3_04', 3, 5, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop does not affect calculation so is ignored', 7044, 'FM Signup 3_05', 3, 5, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop incurs 20 percent penalty', 7070, 'FM Signup 4_01', 3, 4, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop incurs 20 percent penalty', 7071, 'FM Signup 4_02', 3, 4, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop incurs 20 percent penalty', 7072, 'FM Signup 4_03', 3, 4, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop incurs 20 percent penalty', 7073, 'FM Signup 4_04', 3, 4, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Illegal drop incurs 20 percent penalty', 7078, 'FM Signup 4_09', 3, 5, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Charge regular tuition', 8001, 'FM Session 3_01', 3, 6, null,
'(Context is initialized)',
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Charge regular fees', 8002, 'FM Session 3_02', 3, 8, null,
'(Context is initialized)',
'charge rates "", "" with types ".*fee.*", catalogs "", signup operations "ADD,ADD_WITHOUT_PENALTY,TRANSFER_IN"')!

Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Charge 80 percent withdrawal rate', 8003, 'FM Session 3_03', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Charge 60 percent withdrawal rate', 8004, 'FM Session 3_04', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Charge 40 percent withdrawal rate', 8005, 'FM Session 3_05', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Charge 20 percent withdrawal rate', 8006, 'FM Session 3_06', 3, 10, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('Charge and then discount the collaborative engineering courses', 8007, 'FM Session 3_07', 3, 20, null,
...
Insert into KSSA_RULE (DESCRIPTION, ID, NAME, RULE_TYPE_ID_FK, PRIORITY, HEADER, LHS, RHS) values ('', 9001, 'FM Session 4_01', 2, 10, null,
...
Insert into KSSA_RULE_SET_RULE ( RULE_SET_ID_FK, RULE_ID_FK ) values (101, 5020)!
