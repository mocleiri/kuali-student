...
ALTER TABLE KSEN_ATP
	ADD CONSTRAINT  KSEN_ATP_P PRIMARY KEY (ID)   USING INDEX KSEN_ATP_P
/
...
ALTER TABLE KSEN_ATP_ATTR
	ADD CONSTRAINT  KSEN_ATP_ATTR_P PRIMARY KEY (ID)   USING INDEX KSEN_ATP_ATTR_P
/
...
ALTER TABLE KSEN_ATPATP_RELTN
	ADD CONSTRAINT  KSEN_ATPATP_RELTN_P PRIMARY KEY (ID)   USING INDEX KSEN_ATPATP_RELTN_P
/
...
ALTER TABLE KSEN_ATPATP_RELTN_ATTR
	ADD CONSTRAINT  KSEN_ATPATP_RELTN_ATTR_P PRIMARY KEY (ID)   USING INDEX KSEN_ATPATP_RELTN_ATTR_P
/
...
ALTER TABLE KSEN_ATPMSTONE_RELTN
	ADD CONSTRAINT  KSEN_ATPMSTONE_RELTN_P PRIMARY KEY (ID)   USING INDEX KSEN_ATPMSTONE_RELTN_P
/
...
ALTER TABLE KSEN_MSTONE
	ADD CONSTRAINT  KSEN_MSTONE_P PRIMARY KEY (ID)   USING INDEX KSEN_MSTONE_P
/
...
ALTER TABLE KSEN_MSTONE_ATTR
	ADD CONSTRAINT  KSEN_MSTONE_ATTR_P PRIMARY KEY (ID)   USING INDEX KSEN_MSTONE_ATTR_P
/
