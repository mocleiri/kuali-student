Feature: KRMS.ELIG9-2 Natural Language
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Recommended Preparation - rule one
    ...
    Then all pages' text should match "Must have successfully completed HIST210"
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Recommended Preparation - rule two
    ...
    Then both tabs' text should match "Must have successfully completed all courses from (HIST210, HIST110, BSCI124)"
    When I update the manage course offering agendas page
    Then the agenda page's text should match "Must have successfully completed all courses from,HIST110,HIST210,CORE: Life Science Lab-Linked Courses"
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Recommended Preparation - rule three
    ...
    Then both tabs' text should match "Must have successfully completed a minimum of 1 course from (HIST204, HIST213, HIST208, BSCI124)"
    When I update the manage course offering agendas page
    Then the agenda page's text should match "Must have successfully completed a minimum of 1 course from,HIST204,HIST208,HIST213,CORE: Life Science Lab-Linked Courses"
    When I commit and return to see the changes made to the proposition
    Then the agenda page's text should match "Must have successfully completed a minimum of 1 course from,HIST204,HIST208,HIST213,CORE: Life Science Lab-Linked Courses"
    When I want to edit the selected agenda section
    Then both tabs' text should match "Must have successfully completed a minimum of 1 course from (HIST204, HIST213, HIST208, BSCI124)"
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Recommended Preparation - rule four
    ...
    Then both tabs' text should match "Must have successfully completed a minimum of 1 course from (HIST798, HIST250, ENGL381, ENGL390, ENGL392, ENGL395, ENGL391, ENGL393, ENGL394)"
    When I update the manage course offering agendas page
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Antirequisite - rule one
    ...
    Then all pages' text should match "Must not have successfully completed HIST250"
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Corequisite - rule one
    ...
    Then both tabs' text should match "Must be concurrently enrolled in all courses from (HIST798, HIST250, ENGL381, ENGL390, ENGL392, ENGL395, ENGL391, ENGL393, ENGL394)"
    When I update the manage course offering agendas page
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Corequisite - rule two
    ...
    Then both tabs' text should match "Must be concurrently enrolled in a minimum of 1 course from (HIST210, HIST250, ENGL381, ENGL390, ENGL392, ENGL395, ENGL391, ENGL393, ENGL394)"
    When I update the manage course offering agendas page
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Corequisite - rule three
    ...
    Then all pages' text should match "Must be concurrently enrolled in HIST798"
