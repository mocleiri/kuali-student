Feature: KRMS ELIG9.2 Natural Language
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Recommended Preparation - rule one
    ...
    And I add a "course" statement after node "" with course "HIST210"
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Recommended Preparation - rule two
    ...
    And I add a "courses" statement after node "A" with courses "HIST110,HIST210" and course set "CORE: Life Science Lab-Linked Courses (LL)"
    ...
    Then the "logic" tab should have the text "Must have successfully completed all courses from,HIST110,HIST210,CORE: Life Science Lab-Linked Courses (LL)"
    When I update the manage course offering agendas page
    Then the "agenda" page should have the text "Must have successfully completed all courses from,HIST110,HIST210,CORE: Life Science Lab-Linked Courses (LL)"
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Recommended Preparation - rule three
    When I navigate to the agenda page for "Recommended Preparation" for term "201301" and course "ENGL304"
    And I want to edit the selected agenda section
    And I add a "number of courses" statement after node "C" with courses "HIST213,HIST204,HIST208" and course set "CORE: Life Science Lab-Linked Courses (LL)"
    ...
    When I switch to the other tab on the page
    Then the "logic" tab should have the text "Must have successfully completed a minimum of 1 course from,HIST204,HIST208,HIST213,CORE: Life Science Lab-Linked Courses (LL)"
    When I update the manage course offering agendas page
    Then the "agenda" page should have the text "Must have successfully completed a minimum of 1 course from,HIST204,HIST208,HIST213,CORE: Life Science Lab-Linked Courses (LL)"
    When I commit and return to see the changes made to the proposition
    Then the "agenda" page should have the text "Must have successfully completed a minimum of 1 course from,HIST204,HIST208,HIST213,CORE: Life Science Lab-Linked Courses (LL)"
    When I want to edit the selected agenda section
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Recommended Preparation - rule four
    When I navigate to the agenda page for "Recommended Preparation" for term "201301" and course "ENGL304"
    And I want to edit the selected agenda section
    And I add a "number of courses" statement after node "D" with courses "HIST250,HIST798" and course set "General Education: Fundamental Studies-Professional Writing"
...
#ELIG9.2.EB2 (KSENROLL-6954)
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Antirequisite - rule one
    ...
    And I want to add a new statement to the selected agenda section
    And I add a "course" statement after node "" with course "HIST250"
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Corequisite - rule one
    ...
    And I want to add a new statement to the selected agenda section
    And I add a new "courses" statement with courses "HIST250,HIST798" and course set "General Education: Fundamental Studies-Professional Writing"
  ...
  Scenario: Confirm that the natural language displays all rules correctly for Corequisite - rule two
    When I navigate to the agenda page for "Corequisite" for term "201301" and course "HIST110"
    And I want to edit the selected agenda section
    And I add a "number of courses" statement after node "A" with courses "HIST250,HIST210" and course set "General Education: Fundamental Studies-Professional Writing"
