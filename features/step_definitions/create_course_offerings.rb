When /^I create a Course Offering with selected lecture Formats$/ do
  @course_offering = create CourseOffering, :term=> "201612", :course => "ENGL310", :grade_format => "Quiz", :delivery_format => "Lecture/Quiz"
end

And /^I create a Course Offering with selected Delivery Formats$/ do
  @course_offering = create CourseOffering, :term=> "201612", :course => "CHEM132", :grade_format => "Lab", :delivery_format => "Lab"
end
...
And /^I copy a course offering from an existing offering$/ do
  @course_offering = create CourseOffering, :term=> "201612", :course => "CHEM132", :create_from_existing=>(make CourseOffering, :term=> "201201", :course => "CHEM132")
end
