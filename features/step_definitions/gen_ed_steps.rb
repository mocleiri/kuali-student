When(/^I search for a course in the Course Search Page$/) do
  @course_offering = make CourseOffering, :course_code => "ENGL201" ,:description=>"historical",:requisite=>"None",:scheduled_terms=>"SP 14",:projected_terms=>"Check",:gened_requirements=>"General",:subject=>"English",:gened_code=>"DSHU",:gened_course=>"General Education: Humanities"
...
Then(/^I should be able to view the courses meeting the General Education Requirement$/) do
 on CourseSearch do |page|
     ...
     page.gened(row).should match /#{@course_offering.gened_code}/
 end
 end
end
...
When(/^I search for  courses in the Course Search Page$/) do
  @course_offering = make CourseOffering, :course_code => "ENGL" ,:description=>"historical",:requisite=>"None",:scheduled_terms=>"SP 14",:projected_terms=>"Check",:gened_requirements=>"General",:subject=>"English",:gened_code=>"DSSP",:gened_course=>"General Education: Scholarship in Practice"
  @course_offering.course_search
end
