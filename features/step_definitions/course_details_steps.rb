...
on CourseSectionPage do |page|
  page.add_to_button_enabled.exists?.should==true
end
end
...
And(/^I select the activity offerings$/) do
  ...
  on CourseSectionPage do |page|
    ...
    #sleep 10
    puts page.activityoffering_checkbox(description_codescription_level,description_co_term_level,description_formatlist_level,description_fo_level,description_ao_level)
