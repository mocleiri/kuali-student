...
#KSENROLL-13425
  @pending
  Scenario: CR22.3.1 Verify the registered courses table populate and the correct credit count is shown
    When I search for a term by valid term code
  ...
  @pending
  Scenario: CR22.3.2 Verify registered courses table is not populated for student with no registered courses
  ...
  @pending
  Scenario: CR22.3.3 Verify registered course table is populated and default sort order is by course code
    When I search for a term by valid term code
