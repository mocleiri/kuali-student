...
Feature: BT.Search_result_sort
  ...
  Background:
       ...
       Scenario: CS 14.1.1 Successfully sorting the course code in both ascending and descending order.
         When I search for a course on course search
         Then I sort the table by course code
       ...
       Scenario: CS 14.1.2 Successfully sorting the course Title in both ascending and descending order.
         When I search for a course on course search
