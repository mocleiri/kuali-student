...
public class DegreeMapServiceImpl implements DegreeMapService {
	...
	private DegreeMapRequirementDao requirementDao;
	...
	public DegreeMapRequirementDao getRequirementDao() {
		return requirementDao;
	}

	public void setRequirementDao(DegreeMapRequirementDao requirementDao) {
	...
	public DegreeMapRequirementInfo getRequirement(String requirementId,
		...
		DegreeMapRequirementEntity requirement = requirementDao.find(requirementId);
		if (null == requirement) {
	...
	public DegreeMapRequirementInfo createRequirement(
			DegreeMapRequirementInfo requirementId, ContextInfo context)
	...
	public StatusInfo deleteRequirement(String requirementId,
		...
		DegreeMapRequirementEntity dme = requirementDao.find(requirementId);
		if (dme == null ) {
			throw new DoesNotExistException(String.format("Requirement with id Id [%s] does not exist", requirementId));
		}

		requirementDao.remove(dme);
		return status;
