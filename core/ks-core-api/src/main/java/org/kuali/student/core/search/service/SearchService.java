...
public interface SearchService {
	...
	/**
	 * Retrieves the list of search types which return results in the specified
	 * format.
	 * 
	...
	/**
	 * Retrieves the list of search types which use criteria in the specified
	 * format.
	 * 
	...
	/**
	 * Retrieves the list of search result types known by this service. Search
	 * result types describe the return structure for a search.
	 * 
	 * @param None
	 *            No Parameters
	...
	/**
	 * Retrieves information about a particular search result type. Search
	 * result types describe the return structure for a search.
	 * 
	 * @param searchResultTypeKey
	 *            identifier of the search result type
