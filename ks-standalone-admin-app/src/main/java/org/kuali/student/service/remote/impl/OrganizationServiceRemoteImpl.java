...
public class OrganizationServiceRemoteImpl extends OrganizationServiceDecorator {
    ...
    public void setHostUrl(String hostUrl) {
        ...
        URL wsdlURL;
        try {
            String urlStr = hostUrl + "/services/" + OrganizationServiceConstants.SERVICE_NAME_LOCAL_PART + "?wsdl";
        ...
        OrganizationService port = factory.getPort(OrganizationService.class);
