...
public class ProposalServiceRemoteImpl extends ProposalServiceDecorator
{
	...
	public void setHostUrl(String hostUrl)
	{
		...
		try
		{
			String urlStr = hostUrl + "/services/" + ProposalServiceConstants.SERVICE_NAME_LOCAL_PART + "?wsdl";
		...
		ProposalService port = factory.getPort(ProposalService.class);
