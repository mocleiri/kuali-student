...
public class ProgramServiceDecorator implements ProgramService {
    ...
    public void setNextDecorator(ProgramService nextDecorator) {
    ...
    @Override
    @Deprecated
    public SearchResultInfo search(SearchRequestInfo searchRequestInfo, ContextInfo contextInfo) throws MissingParameterException, InvalidParameterException {
