...
public class ProcessServiceRemoteImpl extends ProcessServiceDecorator {
    ...
    public void setHostUrl(String hostUrl) {
        ...
        URL wsdlURL;
        try {
            String urlStr = hostUrl + "/services/" + ProcessServiceConstants.SERVICE_NAME_LOCAL_PART + "?wsdl";
            wsdlURL = new URL(urlStr);
        } catch (MalformedURLException ex) {
            throw new IllegalArgumentException(ex);
        }
        QName qname = new QName(ProcessServiceConstants.NAMESPACE, ProcessServiceConstants.SERVICE_NAME_LOCAL_PART);
        Service factory = Service.create(wsdlURL, qname);
        ProcessService port = factory.getPort(ProcessService.class);
