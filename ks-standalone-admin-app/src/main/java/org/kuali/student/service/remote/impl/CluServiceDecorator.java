...
public class CluServiceDecorator implements CluService {
    ...
    public CluService getNextDecorator() {
    ...
    @Override
    public List<String> getAllowedLuLuRelationTypesForLuType(String luTypeKey, String relatedLuTypeKey, ContextInfo contextInfo) throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
    ...
    @Override
    public List<CluInfo> searchForClus(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator ().searchForClus(criteria, contextInfo);
    }

    @Override
    public List<String> searchForCluIds(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator ().searchForCluIds(criteria, contextInfo);
    }

    @Override
    public List<CluCluRelationInfo> searchForCluCluRelations(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator ().searchForCluCluRelations(criteria, contextInfo);
    }

    @Override
    public List<String> searchForCluCluRelationIds(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator ().searchForCluCluRelationIds(criteria, contextInfo);
    }

    @Override
    public List<CluLoRelationInfo> searchForCluLoRelations(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator ().searchForCluLoRelations(criteria, contextInfo);
    }

    @Override
    public List<String> searchForCluLoRelationIds(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator ().searchForCluLoRelationIds(criteria, contextInfo);
    }

    @Override
    public List<CluPublicationInfo> searchForCluPublications(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator ().searchForCluPublications(criteria, contextInfo);
    }

    @Override
    public List<String> searchForCluPublicationIds(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator ().searchForCluPublicationIds(criteria, contextInfo);
    }

    @Override
    public List<CluResultInfo> searchForCluResults(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator ().searchForCluResults(criteria, contextInfo);
    }

    @Override
    public List<String> searchForCluResultIds(QueryByCriteria criteria, ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
