...
(ID, OBJ_ID,
 ...
 OWNER_TYPE_ID, RELATED_TYPE_ID, RANK, VER_NBR, CREATETIME, CREATEID, UPDATETIME, UPDATEID)
  VALUES ('kuali.type.type.relation.type.allowed.kuali.academicplan.type.planitem.kuali.lui.type.registration.group', null,
          'kuali.type.type.relation.type.allowed', 'kuali.type.type.relation.state.active', null, null,
          'kuali.academicplan.type.planitem', 'kuali.lui.type.registration.group', 1, 0, TIMESTAMP '2013-08-09 00:00:00', 'SYSTEMLOADER', null, null)
/
