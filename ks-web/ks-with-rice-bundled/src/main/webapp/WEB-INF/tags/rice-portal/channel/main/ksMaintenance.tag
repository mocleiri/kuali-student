...
<div class="body">
  ...
  <ul class="chan">
	...
	<li><portal:portalLink displayTitle="true" title="StateChangeInfo Lookup" url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.student.r2.core.class1.state.dto.StateChangeInfo&viewId=KS-StateChangeInfo-AdminLookupView&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
	<li><portal:portalLink displayTitle="true" title="StateConstraintInfo Lookup" url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.student.r2.core.class1.state.dto.StateConstraintInfo&viewId=KS-StateConstraintInfo-AdminLookupView&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
	<li><portal:portalLink displayTitle="true" title="StatePropagationInfo Lookup" url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.student.r2.core.class1.state.dto.StatePropagationInfo&viewId=KS-StatePropagationInfo-AdminLookupView&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
    </ul>
	...
	<li><portal:portalLink displayTitle="true" title="Organization Information Search" url="${ConfigProperties.application.url}/kr-krad/orgInfoAdminManage?viewId=orgInfoManageView&methodToCall=start"/></li>
