 ...
 *         &lt;element name="SSNMatchFlag" type="{http://INAS.collegeboard.org/2013/Input/}ssnMatchIndicatorType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ParentIdentityDataType {
    ...
    @XmlElementRef(name = "SSN", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> ssn;
    @XmlElementRef(name = "SSNMatchFlag", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
