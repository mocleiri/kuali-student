...
public class MultipleChildProtectionAllocationType {
    ...
    @XmlElementRef(name = "AllocationPercent1", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> allocationPercent1;
    @XmlElementRef(name = "AllocationPercent2", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> allocationPercent2;
    @XmlElementRef(name = "AllocationPercent3", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
