 ...
 *       &lt;sequence>
 *         &lt;element name="UseStudentImputedAssets" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="UseParentImputedAssets" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 ...
 *         &lt;element name="UseStudentIncomeOverrides" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="UseParentIncomeOverrides" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="UseProfileAssumptions" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class EfmOptionsType {
    ...
    @XmlElementRef(name = "UseStudentImputedAssets", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> useStudentImputedAssets;
    @XmlElementRef(name = "UseParentImputedAssets", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "UseStudentIncomeOverrides", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> useStudentIncomeOverrides;
    @XmlElementRef(name = "UseParentIncomeOverrides", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> useParentIncomeOverrides;
    @XmlElementRef(name = "UseProfileAssumptions", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
