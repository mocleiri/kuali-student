 ...
 *         &lt;element name="ForceStudentToIndependentStatus" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="StudentCalculateUsTax" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="ParentCalculateUsTax" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="CalculateParentContributionForIndependent" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="ParentNumberInCollegeOverride" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="RejectRStudentSsnMatchOverride" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="RejectSDependentAndFathersBirthDateOverride" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="RejectTDependentAndMotherBirthDateOverride" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="RejectDFirstAndLastNameMatchOverride" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="RejectEDependentAndFathersNameOverride" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="RejectFDependentAndMotherNameDateOverride" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="StudentAllowance" type="{http://INAS.collegeboard.org/2013/Input/}additionalAllowanceType"/>
 *         &lt;element name="ParentAllowance" type="{http://INAS.collegeboard.org/2013/Input/}additionalAllowanceType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FmrExtensionType {
    ...
    @XmlElementRef(name = "ForceStudentToIndependentStatus", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> forceStudentToIndependentStatus;
    @XmlElementRef(name = "StudentCalculateUsTax", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> studentCalculateUsTax;
    @XmlElementRef(name = "ParentCalculateUsTax", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> parentCalculateUsTax;
    @XmlElementRef(name = "CalculateParentContributionForIndependent", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> calculateParentContributionForIndependent;
    @XmlElementRef(name = "ParentNumberInCollegeOverride", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> parentNumberInCollegeOverride;
    @XmlElementRef(name = "RejectRStudentSsnMatchOverride", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> rejectRStudentSsnMatchOverride;
    @XmlElementRef(name = "RejectSDependentAndFathersBirthDateOverride", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> rejectSDependentAndFathersBirthDateOverride;
    @XmlElementRef(name = "RejectTDependentAndMotherBirthDateOverride", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> rejectTDependentAndMotherBirthDateOverride;
    @XmlElementRef(name = "RejectDFirstAndLastNameMatchOverride", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> rejectDFirstAndLastNameMatchOverride;
    @XmlElementRef(name = "RejectEDependentAndFathersNameOverride", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> rejectEDependentAndFathersNameOverride;
    @XmlElementRef(name = "RejectFDependentAndMotherNameDateOverride", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
