 ...
 *       &lt;sequence>
 *         &lt;element name="ActivateStudentImrIsirComparison" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="ActivateParentImrIsirComparison" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="ActivateDataMigration" type="{http://INAS.collegeboard.org/2013/Input/}activateDataMigrationType" minOccurs="0"/>
 *         &lt;element name="DataToMigrate" type="{http://INAS.collegeboard.org/2013/Input/}dataToMigrateType" minOccurs="0"/>
 *         &lt;element name="LimitReportingBasedOnToleranceLimits" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="GenerateProfileEditMessages" type="{http://INAS.collegeboard.org/2013/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="InstDefaultResidencyState" type="{http://INAS.collegeboard.org/2013/Input/}stateProvinceType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OperationalOptionsType {
    ...
    @XmlElementRef(name = "ActivateStudentImrIsirComparison", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> activateStudentImrIsirComparison;
    @XmlElementRef(name = "ActivateParentImrIsirComparison", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> activateParentImrIsirComparison;
    @XmlElementRef(name = "ActivateDataMigration", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<ActivateDataMigrationType> activateDataMigration;
    @XmlElementRef(name = "DataToMigrate", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<DataToMigrateType> dataToMigrate;
    @XmlElementRef(name = "LimitReportingBasedOnToleranceLimits", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> limitReportingBasedOnToleranceLimits;
    @XmlElementRef(name = "GenerateProfileEditMessages", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> generateProfileEditMessages;
    @XmlElementRef(name = "InstDefaultResidencyState", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
