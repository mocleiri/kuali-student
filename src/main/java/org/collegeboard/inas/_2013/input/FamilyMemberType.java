 ...
 *         &lt;element name="AttendCollegeCode" type="{http://INAS.collegeboard.org/2013/Input/}attendCollegeCodeType" minOccurs="0"/>
...
public class FamilyMemberType {
    ...
    @XmlSchemaType(name = "unsignedInt")
    protected Long age;
    @XmlElementRef(name = "AttendCollegeCode", namespace = "http://INAS.collegeboard.org/2013/Input/", type = JAXBElement.class)
