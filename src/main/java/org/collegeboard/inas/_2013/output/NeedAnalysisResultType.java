 ...
 *         &lt;element name="Methodology" type="{http://INAS.collegeboard.org/2013/Output/}methodologyType" minOccurs="0"/>
...
public class NeedAnalysisResultType {
    ...
    @XmlElementRef(name = "Methodology", namespace = "http://INAS.collegeboard.org/2013/Output/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "ConversionPercent", namespace = "http://INAS.collegeboard.org/2013/Output/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "ImAllocationPercent", namespace = "http://INAS.collegeboard.org/2013/Output/", type = JAXBElement.class)
