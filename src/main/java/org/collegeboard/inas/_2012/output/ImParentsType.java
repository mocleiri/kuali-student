 ...
 *         &lt;element name="ForeignAddressIndicator" type="{http://INAS.collegeboard.org/2012/Output/}yesNoType" minOccurs="0"/>
 *         &lt;element name="DataSufficient" type="{http://INAS.collegeboard.org/2012/Output/}yesNoType" minOccurs="0"/>
 *         &lt;element name="CalculationIndicator" type="{http://INAS.collegeboard.org/2012/Output/}yesNoType" minOccurs="0"/>
...
public class ImParentsType {
    ...
    @XmlElementRef(name = "ForeignAddressIndicator", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "CalculationIndicator", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> calculationIndicator;
    @XmlElementRef(name = "CountryCoefficient", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
