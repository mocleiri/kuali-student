 ...
 *       &lt;sequence>
 *         &lt;element name="CustodialParent" type="{http://INAS.collegeboard.org/2012/Output/}custodialParentType" minOccurs="0"/>
 ...
 *         &lt;element name="ParentHomeValueEquityOptionUsage" type="{http://INAS.collegeboard.org/2012/Output/}homeValueEquityOptionUsageType" minOccurs="0"/>
 *         &lt;element name="StudentHomeValueEquityOptionUsage" type="{http://INAS.collegeboard.org/2012/Output/}homeValueEquityOptionUsageType" minOccurs="0"/>
 ...
 *         &lt;element name="DiagnosticMessages" type="{http://INAS.collegeboard.org/2012/Output/}ArrayOfMessageType" minOccurs="0"/>
...
public class MiscCalculationsType {
    ...
    @XmlElementRef(name = "CustodialParent", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "PercentOfIncomeAdjustment", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "NumberInCollegeAllocationPercent", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "ParentImStateTaxRateUsed", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> parentImStateTaxRateUsed;
    @XmlElementRef(name = "ParentEfmStateTaxRateUsed", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> parentEfmStateTaxRateUsed;
    @XmlElementRef(name = "StudentImStateTaxRateUsed", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> studentImStateTaxRateUsed;
    @XmlElementRef(name = "StudentEfmStateTaxRateUsed", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "ParentColaRate", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> parentColaRate;
    @XmlElementRef(name = "ParentHomeValueEquityOptionUsage", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
    protected JAXBElement<HomeValueEquityOptionUsageType> parentHomeValueEquityOptionUsage;
    @XmlElementRef(name = "StudentHomeValueEquityOptionUsage", namespace = "http://INAS.collegeboard.org/2012/Output/", type = JAXBElement.class)
