 ...
 *       &lt;sequence>
 *         &lt;element name="Assumption1ParentNumberInCollegeOverride" type="{http://INAS.collegeboard.org/2012/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="Assumption2ParentAdjustedGrossIncomeOverride" type="{http://INAS.collegeboard.org/2012/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="Assumption3StudentNumberInCollegeOverride" type="{http://INAS.collegeboard.org/2012/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="Assumption4StudentAdjustedGrossIncomeOverride" type="{http://INAS.collegeboard.org/2012/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="Assumption5ParentAdditionalDataOverride" type="{http://INAS.collegeboard.org/2012/Input/}yesNoType" minOccurs="0"/>
 *         &lt;element name="Assumption6StudentAdditonalDataOverride" type="{http://INAS.collegeboard.org/2012/Input/}yesNoType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FmAssumptionsType {
    ...
    @XmlElementRef(name = "Assumption1ParentNumberInCollegeOverride", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> assumption1ParentNumberInCollegeOverride;
    @XmlElementRef(name = "Assumption2ParentAdjustedGrossIncomeOverride", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> assumption2ParentAdjustedGrossIncomeOverride;
    @XmlElementRef(name = "Assumption3StudentNumberInCollegeOverride", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> assumption3StudentNumberInCollegeOverride;
    @XmlElementRef(name = "Assumption4StudentAdjustedGrossIncomeOverride", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> assumption4StudentAdjustedGrossIncomeOverride;
    @XmlElementRef(name = "Assumption5ParentAdditionalDataOverride", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
    protected JAXBElement<YesNoType> assumption5ParentAdditionalDataOverride;
    @XmlElementRef(name = "Assumption6StudentAdditonalDataOverride", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
