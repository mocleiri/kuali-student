 ...
 *       &lt;sequence>
 *         &lt;element name="Option" type="{http://INAS.collegeboard.org/2012/Input/}assetProjectionOptionType" minOccurs="0"/>
...
public class AssetProjectionType {
    ...
    @XmlElementRef(name = "Option", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
    protected JAXBElement<AssetProjectionOptionType> option;
    @XmlElementRef(name = "CashYield1", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "CashYield2", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "InvestmentYield1", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "InvestmentYield2", namespace = "http://INAS.collegeboard.org/2012/Input/", type = JAXBElement.class)
