...
public class CourseOfferingServiceMapImpl implements CourseOfferingService,
    ...
    public StatusInfo deleteCourseOfferingCascaded(String courseOfferingId,
        ...
        try {
            ...
            throw new OperationFailedException(
                    "deleteFormatOfferingCascaded(): failed because dependant objects still exist for courseOfferingId = " + courseOfferingId,
                    e);
        }
    ...
    public CourseOfferingInfo updateCourseOfferingFromCanonical(
            ...
            PermissionDeniedException,
            VersionMismatchException {
        return this.getCourseOffering(courseOfferingId, context);
    }
    ...
    public TypeInfo getActivityOfferingType(String activityOfferingTypeKey,
        ...
        info.setKey(activityOfferingTypeKey);
        info.setName(activityOfferingTypeKey + " name");
        return info;
    }
    ...
    public List<TimeSlotInfo> getAllowedTimeSlotsByDaysAndStartTimeForActivityOffering(
            @WebParam(name = "activityOfferingId") String activityOfferingId,
            @WebParam(name = "daysOfWeek") List<Integer> daysOfWeek, @WebParam(name = "startTime") TimeOfDayInfo startTime,
            @WebParam(name = "contextInfo") ContextInfo contextInfo) throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
    ...
    public StatusInfo deleteActivityOfferingCascaded(String activityOfferingId,
        ...
        try {
            ...
            throw new OperationFailedException(
                    "Dependent object still exists for Activity Offering with id = " + activityOfferingId, e);
        }
    }
    ...
    @Override
    public List<RegistrationGroupInfo> getRegistrationGroupsByActivityOffering(
            @WebParam(name = "activityOfferingId") String activityOfferingId, @WebParam(name = "context") ContextInfo context)
            throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
    ...
    private BulkStatusInfo bulkDeleteRegistrationGroup(RegistrationGroupInfo regGroup, ContextInfo context) throws
            DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
    ...
    public List<BulkStatusInfo> deleteRegistrationGroupsByFormatOffering(
        ...
        try {
            ...
            throw new OperationFailedException(
                    "deleteRegistrationGroupsByFormatOffering (formatOfferingId=" + formatOfferingId + "): failed.", e);
        }
    ...
    public List<BulkStatusInfo> deleteGeneratedRegistrationGroupsByFormatOffering(
        ...
        try {
            ...
            throw new OperationFailedException(
                    "deleteGeneratedRegistrationGroupsByFormatOffering (formatOfferingId=" + formatOfferingId + "): failed", e);
        }
    ...
    public List<ValidationResultInfo> validateRegistrationGroup(
            String validationType, String activityOfferingClusterId, String registrationGroupType,
            RegistrationGroupInfo registrationGroupInfo,
            ContextInfo context) throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
    ...
    @Override
    public List<ActivityOfferingClusterInfo> getActivityOfferingClustersByIds(List<String> activityOfferingClusterIds,
            ContextInfo context) throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
    ...
    public StatusInfo deleteActivityOfferingClusterCascaded(
        ...
        try {
            ...
            throw new OperationFailedException(
                    "unexpected reg group exists for activityOfferingCluster = " + activityOfferingClusterId);
        }
    ...
    public CourseOfferingDisplayInfo getCourseOfferingDisplay(
        ...
        info.setTermName(co.getTermId() + " name");
        info.setTermCode(co.getTermId());
        ...
        info.setTypeName(co.getTypeKey() + " name");
        info.setStateName(co.getStateKey() + " name");
    ...
    public ActivityOfferingDisplayInfo getActivityOfferingDisplay(
        ...
        info.setTypeName(ao.getTypeKey() + " name");
        info.setStateName(ao.getStateKey() + " name");
        ...
        if (ao.getScheduleIds() != null && !ao.getScheduleIds().isEmpty()) {
            List<ScheduleDisplayInfo> scheduleDisplays = new ArrayList<ScheduleDisplayInfo>();
    ...
    public StatusInfo addSeatPoolDefinitionToActivityOffering(
        ...
        if (seatPoolIds.contains(seatPoolDefinitionId)) {
            throw new AlreadyExistsException(
                    "registration group (" + activityOfferingId + ") is already associated to seat pool definition (" + seatPoolDefinitionId + ")");
        }
    ...
    public StatusInfo removeSeatPoolDefinitionFromActivityOffering(
        ...
        if (seatPoolIds.remove(seatPoolDefinitionId)) {
            ...
            throw new DoesNotExistException(
                    "no seatpool association for spId=" + seatPoolDefinitionId + " and activityOfferingId = " + activityOfferingId);
        }
    ...
    public StatusInfo changeCourseOfferingState(
        ...
        try {
            ...
            throw new OperationFailedException(
                    "changeCourseOfferingState (id=" + courseOfferingId + ", nextStateKey=" + nextStateKey, e);
        }
    }
    ...
    public StatusInfo changeFormatOfferingState(
        ...
        try {
            ...
            throw new OperationFailedException(
                    "changeFormatOfferingState (id=" + formatOfferingId + ", nextStateKey=" + nextStateKey, e);
        }
    }
    ...
    public StatusInfo changeActivityOfferingState(
        ...
        try {
            ...
            throw new OperationFailedException(
                    "changeActivityOfferingState (id=" + activityOfferingId + ", nextStateKey=" + nextStateKey, e);
        }
    }
    ...
    public StatusInfo changeRegistrationGroupState(
        ...
        try {
            ...
            throw new OperationFailedException(
                    "changeRegistrationGroupState (id=" + registrationGroupId + ", nextStateKey=" + nextStateKey, e);
        }
    }
    ...
    public StatusInfo changeActivityOfferingClusterState(
        ...
        try {
            ...
            throw new OperationFailedException(
                    "changeActivityOfferingClusterState (id=" + activityOfferingClusterId + ", nextStateKey=" + nextStateKey, e);
        }
    }
    ...
    public StatusInfo changeSeatPoolDefinitionState(
        ...
        try {
            ...
            throw new OperationFailedException(
                    "changeSeatPoolDefinitionState (id=" + seatPoolDefinitionId + ", nextStateKey=" + nextStateKey, e);
        }
    }
