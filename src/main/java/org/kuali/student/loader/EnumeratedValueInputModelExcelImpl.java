 ...
 * @author nwright
 */
public class EnumeratedValueInputModelExcelImpl implements EnumeratedValueInputModel
{

 private SpreadsheetReader reader;

 public EnumeratedValueInputModelExcelImpl (SpreadsheetReader reader)
 {
  this.reader = reader;
 }
