...
public class RulesDataLoader {
    ...
    public void startConversion(){
        ...
        for(StatementInfo statement : rootStatements){
            ...
            //Create new Agenda
            String courseCode = statementHelper.getCourseCodeFromStatement(statement.getId());
            ...
            if(statementTypeToruleTypeConversionMap.containsKey(statement.getType())){
                ...
                AgendaDefinition agenda = AgendaDefinition.Builder.create(null, courseCode+" "+typeName, krmsAgendaTypeID, "10000").build();
                ...
                rootRule = krmsHelper.createRule(RuleDefinition.Builder.create(null, courseCode + " " + typeName, KsKrmsConstants.NAMESPACE_CODE, krmsRuleTypeID, null).build());
            }else{
    ...
    private void processSubStatementsForStatement(StatementInfo statement){
        ...
        for(StatementInfo subStatement : subStatements){
            ...
            if(statementTypeToruleTypeConversionMap.containsKey(subStatement.getType())){
                ...
                String krmsRuleTypeID = krmsHelper.getTypeByName(krmsRuleType,KsKrmsConstants.NAMESPACE_CODE).getId();
                subRule = krmsHelper.createRule(RuleDefinition.Builder.create(null, courseCode + " " + typeName, KsKrmsConstants.NAMESPACE_CODE, krmsRuleTypeID, null).build());
    ...
    private void initTypeConversionMaps(){
        ...
        //TODO need proper list of mappings between these
        ...
        reqCompTypeToPropositionTypeConversionMap.put("kuali.reqComponent.type.course.courseset.credits.completed.nof","kuali.krms.proposition.type.course.courseset.credits.completed.nof");
