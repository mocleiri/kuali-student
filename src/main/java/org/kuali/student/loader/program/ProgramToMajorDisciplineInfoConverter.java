...
public class ProgramToMajorDisciplineInfoConverter
{
 ...
 public ProgramToMajorDisciplineInfoConverter (ProgramLoadResult result, Map<String, Object> thisServiceMap)
 {
  this.result = result;
...
//  info.setProgramRequirements (prog.getProgramRequirements ());
 ...
 private boolean setAdminOrgs(MajorDisciplineInfo info) {
