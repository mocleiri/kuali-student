...
public abstract class AbstractGWTMojo extends AbstractMojo {
   ...
   /************************* Added for classworlds *******************************/

   /**
    * The groupId of Classworlds, which is used to workaround the maximum line length
    * problem on Windows.
    *
    * @parameter default-value="classworlds"
    * @required
    */

   private String classworldsGroupId;

   /**
    * The ArtifactId of Classworlds, which is used to workaround the maximum line length
    * problem on Windows.
    *
    * @parameter default-value="classworlds"
    * @required
   ...
   private String classworldsArtifactId;

   /**
    * The version of Classworlds to use. There is a bug in Classworlds 1.1 and earlier
    * where paths containing spaces are not correctly escaped when converted to URLs.
    *
    * @parameter default-value="1.1"
    * @required
    */
   private String classworldsVersion;

   /**
    * The packaging type of the Classworlds artifact to use.
    *
    * @parameter default-value="jar"
    * @required
    */
   private String classworldsType;

   /**
    * The groupId of the GWT "patch" jar required for Classworlds support.
    *
    * @parameter default-value="com.infocomp"
    * @required
    */

   private String gwtClassworldsGroupId;

   /**
    * The ArtifactId of the GWT "patch" jar required for Classworlds support.
    *
    * @parameter default-value="gwt-dev-classworlds"
    * @required
    */

   private String gwtClassworldsArtifactId;

   /**
    * The version of the GWT "patch" jar required for Classworlds support.
    *
    * @parameter default-value="1.5.3-SNAPSHOT"
    * @required
    */
   private String gwtClassworldsVersion;

   /**
    * The packaging type of the GWT "patch" jar required for Classworlds support.
    *
    * @parameter default-value="jar"
    * @required
    */
   private String gwtClassworldsType;
   ...
   /**
    * Look up the Classworlds {@link Artifact}. This is used when launching
    * hosted mode on the Windows platform to work around the "Input Line Too
    * Long" problem.
    *
    * @return the Classworlds Artifact.
    * @throws MojoExecutionException
    */
   public Artifact getClassworldsArtifact() throws MojoExecutionException {
       Artifact classworldsArtifact = this.factory.createArtifact(classworldsGroupId,
               classworldsArtifactId, classworldsVersion, null, classworldsType);

       try {
           resolver.resolve(classworldsArtifact, this.remoteRepos, this.local);
       } catch(Exception e) {
           String  error = "Error:  Could not resolve classworlds artifact " + classworldsGroupId + ":" +
                   classworldsArtifactId + ":" + classworldsVersion + ".";
           throw new MojoExecutionException(error, e);
       }
       return classworldsArtifact;
   }

   /**
    * Lookup the GWT "patch" {@link Artifact} required for Classworlds support
    * in GWT hosted mode.
    *
    * @return the GWT "patch" Artifact.
    * @throws MojoExecutionException
    */
   public Artifact getGWTClassworldsPatchArtifact() throws MojoExecutionException {
       Artifact gwtArtifact = this.factory.createArtifact(gwtClassworldsGroupId,
               gwtClassworldsArtifactId, gwtClassworldsVersion, null, gwtClassworldsType);

       try {
           resolver.resolve(gwtArtifact, this.remoteRepos, this.local);
       } catch(Exception e) {
           String  error = "Error:  Could not resolve GWT Classworlds support artifact " + gwtClassworldsGroupId + ":" +
                   gwtClassworldsArtifactId + ":" + gwtClassworldsVersion + ".";
           throw new MojoExecutionException(error, e);
       }
       return gwtArtifact;
   }
