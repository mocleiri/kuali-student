 ...
 */
@javax.persistence.Table(name = "WLM", schema = "SIGMA", catalog = "")
@Entity
public class WlmEntity implements Identifiable {
    ...
    private String wlmkey;

    @javax.persistence.Column(name = "WLMKEY")
    @Id
    public String getWlmkey() {
        return wlmkey;
    }

    public void setWlmkey(String wlmkey) {
        this.wlmkey = wlmkey;
    }

    private String usid;

    @javax.persistence.Column(name = "USID")
    @Basic
    ...
    @javax.persistence.Column(name = "TSID")
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        WlmEntity wlmEntity = (WlmEntity) o;

        if (begdte != null ? !begdte.equals(wlmEntity.begdte) : wlmEntity.begdte != null) return false;
        if (crtdtec != null ? !crtdtec.equals(wlmEntity.crtdtec) : wlmEntity.crtdtec != null) return false;
        if (crtmod != null ? !crtmod.equals(wlmEntity.crtmod) : wlmEntity.crtmod != null) return false;
        if (crttime != null ? !crttime.equals(wlmEntity.crttime) : wlmEntity.crttime != null) return false;
        if (crtuser != null ? !crtuser.equals(wlmEntity.crtuser) : wlmEntity.crtuser != null) return false;
        if (enddte != null ? !enddte.equals(wlmEntity.enddte) : wlmEntity.enddte != null) return false;
        if (inactv != null ? !inactv.equals(wlmEntity.inactv) : wlmEntity.inactv != null) return false;
        if (recstat != null ? !recstat.equals(wlmEntity.recstat) : wlmEntity.recstat != null) return false;
        if (revdtec != null ? !revdtec.equals(wlmEntity.revdtec) : wlmEntity.revdtec != null) return false;
        if (revlev != null ? !revlev.equals(wlmEntity.revlev) : wlmEntity.revlev != null) return false;
        if (revmod != null ? !revmod.equals(wlmEntity.revmod) : wlmEntity.revmod != null) return false;
        if (revtime != null ? !revtime.equals(wlmEntity.revtime) : wlmEntity.revtime != null) return false;
        if (revuser != null ? !revuser.equals(wlmEntity.revuser) : wlmEntity.revuser != null) return false;
        if (seclvl != null ? !seclvl.equals(wlmEntity.seclvl) : wlmEntity.seclvl != null) return false;
        if (seqno != null ? !seqno.equals(wlmEntity.seqno) : wlmEntity.seqno != null) return false;
        if (tsid != null ? !tsid.equals(wlmEntity.tsid) : wlmEntity.tsid != null) return false;
        if (ucode != null ? !ucode.equals(wlmEntity.ucode) : wlmEntity.ucode != null) return false;
        if (usid != null ? !usid.equals(wlmEntity.usid) : wlmEntity.usid != null) return false;
        if (usrcd1 != null ? !usrcd1.equals(wlmEntity.usrcd1) : wlmEntity.usrcd1 != null) return false;
        if (usrcd2 != null ? !usrcd2.equals(wlmEntity.usrcd2) : wlmEntity.usrcd2 != null) return false;
        if (usrcd3 != null ? !usrcd3.equals(wlmEntity.usrcd3) : wlmEntity.usrcd3 != null) return false;
        if (usrcd4 != null ? !usrcd4.equals(wlmEntity.usrcd4) : wlmEntity.usrcd4 != null) return false;
        if (usrcd5 != null ? !usrcd5.equals(wlmEntity.usrcd5) : wlmEntity.usrcd5 != null) return false;
        if (usrcd6 != null ? !usrcd6.equals(wlmEntity.usrcd6) : wlmEntity.usrcd6 != null) return false;
        if (usrcd7 != null ? !usrcd7.equals(wlmEntity.usrcd7) : wlmEntity.usrcd7 != null) return false;
        if (usrcd8 != null ? !usrcd8.equals(wlmEntity.usrcd8) : wlmEntity.usrcd8 != null) return false;
        if (usrcd9 != null ? !usrcd9.equals(wlmEntity.usrcd9) : wlmEntity.usrcd9 != null) return false;
        if (usrcda != null ? !usrcda.equals(wlmEntity.usrcda) : wlmEntity.usrcda != null) return false;
        if (usrcdb != null ? !usrcdb.equals(wlmEntity.usrcdb) : wlmEntity.usrcdb != null) return false;
        if (usrcdc != null ? !usrcdc.equals(wlmEntity.usrcdc) : wlmEntity.usrcdc != null) return false;
        if (usrdt1 != null ? !usrdt1.equals(wlmEntity.usrdt1) : wlmEntity.usrdt1 != null) return false;
        if (usrdt2 != null ? !usrdt2.equals(wlmEntity.usrdt2) : wlmEntity.usrdt2 != null) return false;
        if (usrdt3 != null ? !usrdt3.equals(wlmEntity.usrdt3) : wlmEntity.usrdt3 != null) return false;
        if (usrdt4 != null ? !usrdt4.equals(wlmEntity.usrdt4) : wlmEntity.usrdt4 != null) return false;
        if (usrdt5 != null ? !usrdt5.equals(wlmEntity.usrdt5) : wlmEntity.usrdt5 != null) return false;
        if (usrdt6 != null ? !usrdt6.equals(wlmEntity.usrdt6) : wlmEntity.usrdt6 != null) return false;
        if (usrdt7 != null ? !usrdt7.equals(wlmEntity.usrdt7) : wlmEntity.usrdt7 != null) return false;
        if (usrdt8 != null ? !usrdt8.equals(wlmEntity.usrdt8) : wlmEntity.usrdt8 != null) return false;
        if (usrnr1 != null ? !usrnr1.equals(wlmEntity.usrnr1) : wlmEntity.usrnr1 != null) return false;
        if (usrnr2 != null ? !usrnr2.equals(wlmEntity.usrnr2) : wlmEntity.usrnr2 != null) return false;
        if (usrnr3 != null ? !usrnr3.equals(wlmEntity.usrnr3) : wlmEntity.usrnr3 != null) return false;
        if (usrnr4 != null ? !usrnr4.equals(wlmEntity.usrnr4) : wlmEntity.usrnr4 != null) return false;
        if (usrnr5 != null ? !usrnr5.equals(wlmEntity.usrnr5) : wlmEntity.usrnr5 != null) return false;
        if (usrnr6 != null ? !usrnr6.equals(wlmEntity.usrnr6) : wlmEntity.usrnr6 != null) return false;
        if (usrnr7 != null ? !usrnr7.equals(wlmEntity.usrnr7) : wlmEntity.usrnr7 != null) return false;
        if (usrnr8 != null ? !usrnr8.equals(wlmEntity.usrnr8) : wlmEntity.usrnr8 != null) return false;
        if (wlmkey != null ? !wlmkey.equals(wlmEntity.wlmkey) : wlmEntity.wlmkey != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (wlmkey != null ? wlmkey.hashCode() : 0);
