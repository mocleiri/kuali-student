...
import org.kuali.student.core.atp.dto.StatusInfo;

/**
 *
 * @Author KSContractMojo
 * @Author Daniel Epstein
 * @Since Wed Jan 12 16:05:19 EST 2011
 * @See <a href="https://wiki.kuali.org/display/KULSTU/Academic+Time+Period+Service">AtpService</>
 *
 */
@WebService(name = "AtpService", targetNamespace = "http://student.kuali.org/wsdl/atp") // TODO CHECK THESE VALUES
...
public interface AtpService { 
     ...
     * @throws OperationFailedException unable to complete request
	 */
    public List<String> getMilestoneTypesForAtpType(@WebParam(name="atpTypeKey")String atpTypeKey) throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException;
     ...
     * @param atpTypeKey atpTypeKey
     * @return List of daterange types
     * @throws DoesNotExistException specified atpTypeKey not found
     * @throws InvalidParameterException invalid atpTypeKey
     * @throws MissingParameterException atpTypeKey not specified
     * @throws OperationFailedException unable to complete request
	 */
    public List<String> getDateRangeTypesForAtpType(@WebParam(name="atpTypeKey")String atpTypeKey) throws DoesNotExistException, InvalidParameterException, MissingParameterException, OperationFailedException;
