...
public class OrgFinderHelperTest
{
 ...
 public static void setUpClass () throws Exception
 {
  ...
  CourseServiceFactory factory2 = new CourseServiceFactory ();
  factory2.setHostUrl (CreditCourseInputModelFactory.LOCAL_HOST_URL);
  courseService = factory2.getCourseService ();
 }
 @AfterClass
