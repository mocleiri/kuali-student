...
@XmlRootElement(name = "InvalidParameterException", namespace = "http://student.kuali.org/wsdl/exceptions")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "InvalidParameterException", namespace = "http://student.kuali.org/wsdl/exceptions")
