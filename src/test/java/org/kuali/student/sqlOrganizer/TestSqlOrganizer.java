...
public class TestSqlOrganizer {
    ...
    private String extractMilestone(String filePathName) {
    ...
    public void testExtractMilestone() {
        ...
        assertEquals("NO_MILESTONE_IN_PATH", extractMilestone(incorrectLinuxPath));
        assertEquals("NO_MILESTONE_IN_PATH", extractMilestone(incorrectWindowsPath));
        assertEquals("Milestone.1", extractMilestone(correctLinuxPath));
        assertEquals("Milestone.1", extractMilestone(correctWindowsPath));
    ...
    private void processSqlStatements(String sqlFile) throws IOException {
        ...
        if (skipSqlOrganization(firstStatement)) {
            System.out.print(fileReport.toString());

            TypeMapping typeMapping = new TypeMapping();
            ControlMappingStatus status = setControlDataType(firstStatement, filename, typeMapping);
    ...
    public void delEmptyDirs(File dir) {
        if (dir.isDirectory()) {
    ...
    public void deleteDirFiles(File dir) {
    ...
    public boolean mkDirCascaded(File path) {
        boolean ret = false;
        if (!path.exists()) {
    ...
    public void cascadeDelDir(File dir) {
        if (dir.isDirectory()) {
            for (File file : dir.listFiles()) {
                cascadeDelDir(file);
            }
    ...
    public void testDirManipulations() {
        ...
        dirs.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir1"));
        dirs.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir1/dir1.1"));
        dirs.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir1/dir1.2"));

        List<File> postDelDirs = new ArrayList<File>();
        dirs.add(new File(OUTPUT_DIR_PATH + "/testFolder"));
        dirs.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir2"));
        dirs.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir2/dir2.1"));
        dirs.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir2/dir2.2"));

        dirs.addAll(postDelDirs);

        List<File> files = new ArrayList<File>();
        files.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir1/dir1.1/file1"));
        files.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir1/dir1.1/file2"));
        files.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir1/dir1.1/file3"));
        files.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir1/dir1.1/file4"));

        List<File> postDelFiles = new ArrayList<File>();
        postDelFiles.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir2/file5"));
        postDelFiles.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir2/file6"));
        postDelFiles.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir2/file7"));
        postDelFiles.add(new File(OUTPUT_DIR_PATH + "/testFolder/dir2/file8"));
        ...
        File delDir = new File(OUTPUT_DIR_PATH + "/testFolder/dir1");
        cascadeDelDir(delDir);
        assertFalse(delDir.exists());
        ...
        //test cleanOutputDir
        File rootDir = new File(OUTPUT_DIR_PATH + "/testFolder");
        cleanOutputDir(rootDir);
        for (File file : postDelFiles) {
            assertFalse(file.exists());
        }

        cascadeDelDir(rootDir);
