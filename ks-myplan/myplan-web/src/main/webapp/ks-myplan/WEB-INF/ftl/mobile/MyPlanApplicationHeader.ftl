...
<div id="mobileHeader" data-role="header">
    ...
    <a href="#globalNav" data-rel="popup" data-icon="grid" data-iconpos="notext" data-theme="d" data-shadow="false" data-iconshadow="false" data-position-to="origin" class="myplan-mobile-menu ui-btn-right">Menu</a>
