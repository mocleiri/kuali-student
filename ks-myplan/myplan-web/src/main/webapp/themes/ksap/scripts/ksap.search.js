...
function searchForCourses(id, parentId) {
    ...
    oTable = jQuery("#" + id).dataTable({
        ...
        oLanguage: {
            ...
            "sInfo": (formData.searchTerm === 'any' ? 'Showing _START_-_END_ of _TOTAL_ results' : '<div>Showing _START_-_END_ of _TOTAL_ filtered search results</div><div class="courseResults__note">Courses listed below may include associated sections that occur outside of your selected search filters.</div>'),
