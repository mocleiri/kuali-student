...
INSERT INTO KSEN_LUI (ID, CLU_ID, TYPE_ID, STATE_ID, RT_DESCR_ID, EFF_DT, EXP_DT, OFFIC_LUI_ID, VER_NBR, ATP_ID) VALUES ('Lui-1', 'cluId1', 'kuali.lui.type.course.offering', 'kuali.lui.state.draft', 'Lui-1-Desc', {ts '2011-01-01 00:00:00.0'}, {ts '2011-12-31 00:00:00.0'}, 'LUI-IDENT-1', 0,'testTermId1')
...
INSERT INTO KSEN_LPR_ROSTER (ID,CREATEID,CREATETIME,UPDATEID,UPDATETIME,OBJ_ID,VER_NBR,RT_DESCR_ID,MAX_CAPACITY,CHECK_IN_REQ,STATE_ID,TYPE_ID,ATP_DUR_TYP_KEY,TM_QUANTITY) VALUES ('testLprRoster1',null,null,null,null,null,null,'RICHTEXT-TRT-9',5,0,'kuali.lpr.roster.state.ready','kuali.lpr.roster.type.course.grade.final','testTermId1',null)
INSERT INTO KSEN_LPR_ROSTER_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('testLprRoster1.name', 'en', 'Chemistry I Roster', '', 'testLprRoster1')
