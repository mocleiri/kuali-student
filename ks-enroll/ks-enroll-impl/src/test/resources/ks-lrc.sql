...
///////////////////////////////////////////////////////////////////////////
INSERT INTO KSEN_LRC_RES_SCALE (ID,VER_NBR,RT_DESCR_ID,STATE_ID,TYPE_ID) VALUES ('kuali.result.scale.grade.letter',1, 'RICHTEXT-221','kuali.result.scale.state.approved','kuali.result.scale.type.grade')
INSERT INTO KSEN_LRC_RES_SCALE_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.result.scale.grade.letter.name', 'en', 'A-F Grading Scale', '', 'kuali.result.scale.grade.letter')

INSERT INTO KSEN_LRC_RES_VAL_GRP(ID,RT_DESCR_ID,TYPE_ID,STATE_ID,RES_SCALE_ID) VALUES ('kuali.resultComponent.grade.letter','RICHTEXT-111','kuali.result.values.group.type.multiple','kuali.result.values.group.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VAL_GRP_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.resultComponent.grade.letter.name', 'en', 'Standard A-F Grading', '', 'kuali.resultComponent.grade.letter')


INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.a','kuali.result.scale.type.grade','RICHTEXT-222','A','kuali.result.value.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.b','kuali.result.scale.type.grade','RICHTEXT-223','B','kuali.result.value.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.c','kuali.result.scale.type.grade','RICHTEXT-224','C','kuali.result.value.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.d','kuali.result.scale.type.grade','RICHTEXT-225','D','kuali.result.value.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.letter.f','kuali.result.scale.type.grade','RICHTEXT-226','F','kuali.result.value.state.approved','kuali.result.scale.grade.letter')

INSERT INTO KSEN_LRC_RES_VALUE_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.result.value.grade.letter.a.name', 'en', 'Excellent', '', 'kuali.result.value.grade.letter.a')
INSERT INTO KSEN_LRC_RES_VALUE_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.result.value.grade.letter.b.name', 'en', 'Good', '', 'kuali.result.value.grade.letter.b')
INSERT INTO KSEN_LRC_RES_VALUE_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.result.value.grade.letter.c.name', 'en', 'Average', '', 'kuali.result.value.grade.letter.c')
INSERT INTO KSEN_LRC_RES_VALUE_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.result.value.grade.letter.d.name', 'en', 'Below Average', '', 'kuali.result.value.grade.letter.d')
INSERT INTO KSEN_LRC_RES_VALUE_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.result.value.grade.letter.f.name', 'en', 'Failing', '', 'kuali.result.value.grade.letter.f')
...
INSERT INTO KSEN_LRC_RES_SCALE (ID,VER_NBR,RT_DESCR_ID,STATE_ID,TYPE_ID) VALUES ('kuali.result.scale.grade.pf',1,'RICHTEXT-227','kuali.result.scale.state.approved','kuali.result.scale.type.grade')
INSERT INTO KSEN_LRC_RES_SCALE_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.result.scale.grade.pf.name', 'en', 'Pass/Fail Grading Scale', '', 'kuali.result.scale.grade.pf')

INSERT INTO KSEN_LRC_RES_VAL_GRP(ID,RT_DESCR_ID,TYPE_ID,STATE_ID,RES_SCALE_ID) VALUES ('kuali.resultComponent.grade.passFail','RICHTEXT-228','kuali.result.values.group.type.multiple','kuali.result.values.group.state.approved','kuali.result.scale.grade.letter')
INSERT INTO KSEN_LRC_RES_VAL_GRP_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.resultComponent.grade.passFail.name', 'en', 'Pass/Fail Grading', '', 'kuali.resultComponent.grade.passFail')


INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.pf.p','kuali.result.scale.type.grade','RICHTEXT-229','P','kuali.result.value.state.approved','kuali.result.scale.grade.pf')
INSERT INTO KSEN_LRC_RES_VALUE (ID,TYPE_ID,RT_DESCR_ID,VALUE,STATE_ID,RES_SCALE_ID) VALUES ('kuali.result.value.grade.pf.f','kuali.result.scale.type.grade','RICHTEXT-230','F','kuali.result.value.state.approved','kuali.result.scale.grade.pf')

INSERT INTO KSEN_LRC_RES_VALUE_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.result.value.grade.pf.p.name', 'en', 'Pass', '', 'kuali.result.value.grade.pf.p')
INSERT INTO KSEN_LRC_RES_VALUE_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('kuali.result.value.grade.pf.f.name', 'en', 'Fail', '', 'kuali.result.value.grade.pf.f')
