...
INSERT INTO KSEN_LUI (ID, CLU_ID, TYPE_ID, STATE_ID, RT_DESCR_ID, EFF_DT, EXP_DT, VER_NBR) VALUES ('Lui-5', 'cluId5', 'kuali.lui.type.activity.offering.lab', 'kuali.lui.state.draft', 'Lui-5-Desc', {ts '2011-01-01 00:00:00.0'}, {ts '2011-12-31 00:00:00.0'}, 0)
...
INSERT INTO KSEN_LUI_NAME (ID, LOCALE, NAME, OBJ_ID, OWNER) VALUES ('Lui-5.name', 'en', 'Lui five', '', 'Lui-5')
