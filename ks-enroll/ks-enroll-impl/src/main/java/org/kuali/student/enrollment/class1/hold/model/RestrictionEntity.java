...
public class RestrictionEntity extends MetaEntity implements AttributeOwner<RestrictionAttributeEntity>, NameOwner<RestrictionNameEntity> {
    
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "owner")
    private List<RestrictionNameEntity> names = new ArrayList<RestrictionNameEntity>();
    ...
    public RestrictionEntity(Restriction restriction){
        ...
        try {
	        ...
	        this.setNames(new ArrayList<RestrictionNameEntity>());
	        if (null != restriction.getNames()) {
	            for (Name name : restriction.getNames()) {
	                this.getNames().add(new RestrictionNameEntity(name));
	            }
	        }
    ...
    public RestrictionInfo toDto() {
        ...
        for (RestrictionNameEntity name : getNames()) {
	...
	public List<RestrictionNameEntity> getNames() {
		return names;
	}

	public void setNames(List<RestrictionNameEntity> names) {
		this.names = names;
	}
