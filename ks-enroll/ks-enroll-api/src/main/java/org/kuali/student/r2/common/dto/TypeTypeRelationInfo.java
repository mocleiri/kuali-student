...
@XmlType(name = "TypeTypeRelationInfo", propOrder = {"key", "typeKey", "stateKey", "names", "descr", "effectiveDate", "expirationDate", "ownerTypeKey", "relatedTypeKey", "rank", "attributes", "meta", "_futureElements"})
