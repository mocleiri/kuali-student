...
public class TransactionImportServiceImpl extends GenericPersistenceService implements TransactionImportService {
    ...
    private static final String IMPORT_SCHEMA_LOCATION = "classpath*:/xsd/import-transaction.xsd";
    ...
    private BigDecimal failedValue = BigDecimal.ZERO;
    ...
    private String parseTransactions(String xml) {
        ...
        singleBatchFailure = Boolean.valueOf(configService.getInitialParameter(Constants.IMPORT_SINGLE_BATCH_FAILURE));
