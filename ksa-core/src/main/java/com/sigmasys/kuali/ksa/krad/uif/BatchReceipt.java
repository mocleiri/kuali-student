...
public class BatchReceipt extends AccountIdAware implements Identifiable {
    ...
    @TableGenerator(name = "TABLE_GEN_BATCH_RECEIPT",
            table = "KSSA_SEQUENCE_TABLE",
            pkColumnName = "SEQ_NAME",
            valueColumnName = "SEQ_VALUE",
            pkColumnValue = "BATCH_RECEIPT_SEQ")
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "TABLE_GEN_BATCH_RECEIPT")
    @Override
    public Long getId() {
        return id;
    }
