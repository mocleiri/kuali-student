...
import com.sigmasys.kuali.ksa.krad.form.KsaAccountImportForm;
...
@Controller
@RequestMapping(value = "/ksaAccountImportVw")
public class KsaAccountImportController extends GenericSearchController {

   private static final Log logger = LogFactory.getLog(KsaAccountImportController.class);
    ...
    */
   @Override
   protected KsaAccountImportForm createInitialForm(HttpServletRequest request) {
	   KsaAccountImportForm form = new KsaAccountImportForm();
   ...
   public ModelAndView get(@ModelAttribute("KualiForm") KsaAccountImportForm form, BindingResult result,
   ...
   public ModelAndView start(@ModelAttribute("KualiForm") KsaAccountImportForm form, BindingResult result,
                             HttpServletRequest request, HttpServletResponse response) {
   ...
   public ModelAndView submit(@ModelAttribute("KualiForm") KsaAccountImportForm form, BindingResult result,
                              HttpServletRequest request, HttpServletResponse response) {
      // do submit stuff...
   ...
   @Transactional(readOnly = false)
   public ModelAndView save(@ModelAttribute("KualiForm") KsaAccountImportForm form, BindingResult result,
                            HttpServletRequest request, HttpServletResponse response) {
   ...
   public ModelAndView cancel(@ModelAttribute ("KualiForm") KsaAccountImportForm form, BindingResult result,
                              HttpServletRequest request, HttpServletResponse response) {
      // do cancel stuff...
      return getUIFModelAndView(form);
   }
   ...
   public ModelAndView refresh(@ModelAttribute("KualiForm") KsaAccountImportForm form, BindingResult result,
                               HttpServletRequest request, HttpServletResponse response) {
      // do refresh stuff...
      return getUIFModelAndView(form);
   }
