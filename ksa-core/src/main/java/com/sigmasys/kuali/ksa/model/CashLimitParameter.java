...
public class CashLimitParameter extends AuditableEntity<Long> {
    ...
    @TableGenerator(name = "TABLE_GEN_CASH_LIMIT_PARAMETER",
            table = "KSSA_SEQUENCE_TABLE",
            pkColumnName = "SEQ_NAME",
            valueColumnName = "SEQ_VALUE",
            pkColumnValue = "CASH_LIMIT_PARAMETER_SEQ")
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "TABLE_GEN_CASH_LIMIT_PARAMETER")
    @Override
    public Long getId() {
        return id;
    }
