...
import com.sigmasys.kuali.ksa.krad.form.KsaCurrencyForm;
 ...
 */
@Controller
@RequestMapping(value = "/ksaCurrencyVw")
public class KsaCurrencyController extends GenericSearchController {
    ...
    */
   @Override
   protected KsaCurrencyForm createInitialForm(HttpServletRequest request) {
      KsaCurrencyForm form = new KsaCurrencyForm();
   ...
   public ModelAndView get(@ModelAttribute("KualiForm") KsaCurrencyForm form, BindingResult result,
   ...
   public ModelAndView start(@ModelAttribute("KualiForm") KsaCurrencyForm form, BindingResult result,
                             HttpServletRequest request, HttpServletResponse response) {
   ...
   public ModelAndView submit(@ModelAttribute("KualiForm") KsaCurrencyForm form, BindingResult result,
                              HttpServletRequest request, HttpServletResponse response) {
      // do submit stuff...
   ...
   @Transactional(readOnly = false)
   public ModelAndView save(@ModelAttribute("KualiForm") KsaCurrencyForm form, BindingResult result,
                            HttpServletRequest request, HttpServletResponse response) {
   ...
   public ModelAndView cancel(@ModelAttribute ("KualiForm") KsaCurrencyForm form, BindingResult result,
                              HttpServletRequest request, HttpServletResponse response) {
      // do cancel stuff...
      return getUIFModelAndView(form);
   }
   ...
   public ModelAndView insertCurrency(@ModelAttribute("KualiForm") KsaCurrencyForm form, BindingResult result,
                               HttpServletRequest request, HttpServletResponse response) {
      // do insert stuff...
      String statusMsg = "";
   ...
   public ModelAndView updateCurrency(@ModelAttribute("KualiForm") KsaCurrencyForm form, BindingResult result,
                               HttpServletRequest request, HttpServletResponse response) {
      // do update stuff...
      String viewId = request.getParameter("viewId");
      String pageId = request.getParameter("pageId");
