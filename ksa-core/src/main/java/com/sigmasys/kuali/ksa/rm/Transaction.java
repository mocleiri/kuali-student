...
public abstract class Transaction {
	...
	*/
	...
	/**  If a document reference is altered, then a new one can be rereferenced. The documents associated wtih each transaction give more details about the transaction, and are 
