 ...
 * instantly. The refundability of a transaciton based on this date does NOT affect the refund flag isRefundable, which is set for transactions which are inherently non refundable,
