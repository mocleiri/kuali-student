...
public abstract class Debit extends Transaction {
	...
	/** as getGlaccounts, but also returns the breakout of the amounts to the Gl accounts. For example, if this transaction is for $1000, and sends 30% to account 111 and 70% to 222 then
	 * the system will return the breakout amounts as well as the gl accounts.
	 */
	...
	/** Gets the priority of the debit from the transaction code. The prioroty of a transaction defines when it is paid off in the payment allocation system.
