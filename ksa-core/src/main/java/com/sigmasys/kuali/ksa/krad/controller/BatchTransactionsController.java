...
import com.sigmasys.kuali.ksa.krad.form.BatchTransactionsForm;
...
public class BatchTransactionsController extends GenericSearchController {
    ...
    */
   @Override
   protected BatchTransactionsForm createInitialForm(HttpServletRequest request) {
      BatchTransactionsForm form = new BatchTransactionsForm();
   ...
   public ModelAndView get(@ModelAttribute("KualiForm") BatchTransactionsForm form, BindingResult result,
   ...
   public ModelAndView start(@ModelAttribute("KualiForm") BatchTransactionsForm form, BindingResult result,
                             HttpServletRequest request, HttpServletResponse response) {
   ...
   public ModelAndView submit(@ModelAttribute("KualiForm") BatchTransactionsForm form, BindingResult result,
                              HttpServletRequest request, HttpServletResponse response) {
      // do submit stuff...
   ...
   @Transactional(readOnly = false)
   public ModelAndView save(@ModelAttribute("KualiForm") BatchTransactionsForm form, BindingResult result,
                            HttpServletRequest request, HttpServletResponse response) {
   ...
   public ModelAndView cancel(@ModelAttribute ("KualiForm") BatchTransactionsForm form, BindingResult result,
                              HttpServletRequest request, HttpServletResponse response) {
      // do cancel stuff...
      return getUIFModelAndView(form);
   }
   ...
   public ModelAndView refresh(@ModelAttribute("KualiForm") BatchTransactionsForm form, BindingResult result,
                               HttpServletRequest request, HttpServletResponse response) {
      // do refresh stuff...
      return getUIFModelAndView(form);
   }
   ...
   public ModelAndView ageAccounts(@ModelAttribute("KualiForm") BatchTransactionsForm form, BindingResult result,
                               HttpServletRequest request, HttpServletResponse response) {
