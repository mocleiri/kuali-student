...
[then][]charge rates "{rateCodes}", "{rateSubCodes}" with types "{rateTypeCodes}", catalogs "{rateCatalogCodes}", signup operations "{signupOperations}" = context.getFmService().chargeSignupRates("{rateCodes}","{rateSubCodes}","{rateTypeCodes}","{rateCatalogCodes}","{signupOperations}",null,context);
[then][]charge rates "{rateCodes}", "{rateSubCodes}" in amount of {percentage}% with types "{rateTypeCodes}", catalogs "{rateCatalogCodes}", signup operations "{signupOperations}" = context.getFmService().chargeSignupRates("{rateCodes}","{rateSubCodes}","{rateTypeCodes}","{rateCatalogCodes}","{signupOperations}",new BigDecimal({percentage}),context);
