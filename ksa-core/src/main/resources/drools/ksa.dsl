...
[when][]units with rate codes"{rateCodes}" is units with rate codes "{takenRateCodes}" = fmService.compareNumberOfTakenUnits("{rateCodes}","{takenRateCodes}","==",context)
[when][]units with rate codes "{rateCodes}" gt taken units with rate codes "{takenRateCodes}" = fmService.compareNumberOfTakenUnits("{rateCodes}","{takenRateCodes}",">",context)
[when][]units with rate codes "{rateCodes}" gte taken units with rate codes "{takenRateCodes}" = fmService.compareNumberOfTakenUnits("{rateCodes}","{takenRateCodes}",">=",context)
[when][]units with rate codes "{rateCodes}" lt taken units with rate codes "{takenRateCodes}" = fmService.compareNumberOfTakenUnits("{rateCodes}","{takenRateCodes}","<",context)
[when][]units with rate codes "{rateCodes}" lte taken units with rate codes "{takenRateCodes}" = fmService.compareNumberOfTakenUnits("{rateCodes}","{takenRateCodes}","<=",context)
[when][]amount with rate codes "{rateCodes}" is taken amount with rate codes "{takenRateCodes}" = fmService.compareAmountOfTakenSignups("{rateCodes}","{takenRateCodes}","==",context)
[when][]amount with rate codes "{rateCodes}" gt taken amount with rate codes "{takenRateCodes}" = fmService.compareAmountOfTakenSignups("{rateCodes}","{takenRateCodes}",">",context)
[when][]amount with rate codes "{rateCodes}" gte taken amount with rate codes "{takenRateCodes}" = fmService.compareAmountOfTakenSignups("{rateCodes}","{takenRateCodes}",">=",context)
[when][]amount with rate codes "{rateCodes}" lt taken amount with rate codes "{takenRateCodes}" = fmService.compareAmountOfTakenSignups("{rateCodes}","{takenRateCodes}","<",context)
[when][]amount with rate codes "{rateCodes}" lte taken amount with rate codes "{takenRateCodes}" = fmService.compareAmountOfTakenSignups("{rateCodes}","{takenRateCodes}","<=",context)
