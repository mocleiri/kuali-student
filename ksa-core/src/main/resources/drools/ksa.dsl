...
[when][]signup date is on atp milestone "{milestoneType}" = fmService.compareSignupEffectiveDateToAtpMilestone("{milestoneType}","==",context)
[when][]signup date is after atp milestone "{milestoneType}" = fmService.compareSignupEffectiveDateToAtpMilestone("{milestoneType}",">",context)
[when][]signup date is before atp milestone "{milestoneType}" = fmService.compareSignupEffectiveDateToAtpMilestone("{milestoneType}","<",context)
[when][]signup date is on or after atp milestone "{milestoneType}" = fmService.compareSignupEffectiveDateToAtpMilestone("{milestoneType}",">=",context)
[when][]signup date is on or before atp milestone "{milestoneType}" = fmService.compareSignupEffectiveDateToAtpMilestone("{milestoneType}","<=",context)
...
[then][]mark immediate preceding offerings as complete = context.getFmService().setImmediatePrecedingOfferingsComplete(true,null,context);
[then][]mark immediate preceding offerings as not complete = context.getFmService().setImmediatePrecedingOfferingsComplete(false,null,context);
[then][]mark immediate preceding offerings with operation "{operations}" as complete = context.getFmService().setImmediatePrecedingOfferingsComplete(true,"{operations}",context);
[then][]mark immediate preceding offerings as taken = context.getFmService().setImmediatePrecedingOfferingsTaken(true,null,context);
[then][]mark immediate preceding offerings as not taken = context.getFmService().setImmediatePrecedingOfferingsTaken(false,null,context);
[then][]mark immediate preceding offerings with operation "{operations}" as taken = context.getFmService().setImmediatePrecedingOfferingsTaken(true,"{operations}",context);
[then][]add signup rate "{rateCode}", "{rateSubCode}" = context.getFmService().addRate("{rateCode}","{rateSubCode}",context);
[then][]add rate "{rateCode}", "{rateSubCode}" to signups with rates "{rateCodes}", "{rateSubCodes}", types "{rateTypeCodes}", catalogs "{rateCatalogCodes}", signup operations "{signupOperations}" = context.getFmService().addRate("{rateCode}","{rateSubCode}", "{rateCodes}","{rateSubCodes}","{rateTypeCodes}","{rateCatalogCodes}","{signupOperations}",context);
...
[then][]mark signup rates "{rateCodes}", "{rateSubCodes}" as complete with types "{rateTypeCodes}", catalogs "{rateCatalogCodes}", signup operations "{signupOperations}" = context.getFmService().setSignupRatesComplete("{rateCodes}","{rateSubCodes}","{rateTypeCodes}","{rateCatalogCodes}","{signupOperations}",true,context);
[then][]mark signup rates "{rateCodes}", "{rateSubCodes}" as not complete with types "{rateTypeCodes}", catalogs "{rateCatalogCodes}", signup operations "{signupOperations}" = context.getFmService().setSignupRatesComplete("{rateCodes}","{rateSubCodes}","{rateTypeCodes}","{rateCatalogCodes}","{signupOperations}",false,context);
[then][]mark signup rates "{rateCodes}", "{rateSubCodes}" as complete = context.getFmService().setSignupRatesComplete("{rateCodes}","{rateSubCodes}",null,null,null,true,context);
[then][]mark signup rates "{rateCodes}", "{rateSubCodes}" as not complete = context.getFmService().setSignupRatesComplete("{rateCodes}","{rateSubCodes}",null,null,null,false,context);
[then][]charge rates of taken signups "{rateCodes}", "{rateSubCodes}" with types "{rateTypeCodes}", catalogs "{rateCatalogCodes}", signup operations "{signupOperations}" = context.getFmService().chargeSignupRates("{rateCodes}","{rateSubCodes}","{rateTypeCodes}","{rateCatalogCodes}","{signupOperations}",null,true,context);
[then][]charge rates of not taken signups "{rateCodes}", "{rateSubCodes}" with types "{rateTypeCodes}", catalogs "{rateCatalogCodes}", signup operations "{signupOperations}" = context.getFmService().chargeSignupRates("{rateCodes}","{rateSubCodes}","{rateTypeCodes}","{rateCatalogCodes}","{signupOperations}",null,false,context);
[then][]charge rates "{rateCodes}", "{rateSubCodes}" with types "{rateTypeCodes}", catalogs "{rateCatalogCodes}", signup operations "{signupOperations}" = context.getFmService().chargeSignupRates("{rateCodes}","{rateSubCodes}","{rateTypeCodes}","{rateCatalogCodes}","{signupOperations}",null,null,context);
[then][]charge rates "{rateCodes}", "{rateSubCodes}" in amount of {percentage}% with types "{rateTypeCodes}", catalogs "{rateCatalogCodes}", signup operations "{signupOperations}" = context.getFmService().chargeSignupRates("{rateCodes}","{rateSubCodes}","{rateTypeCodes}","{rateCatalogCodes}","{signupOperations}",new BigDecimal({percentage}),null,context);
[then][]charge incidental rate "{rateCode}", "{rateSubCode}" with {units} units in amount of ${amount} using id "{internalChargeId}" = context.getFmService().chargeIncidentalRate("{rateCode}","{rateSubCode}","{internalChargeId}",new UnitNumber({units}),new BigDecimal({amount}),context);
[then][]charge incidental rate "{rateCode}", "{rateSubCode}" with {units} units using id "{internalChargeId}" = context.getFmService().chargeIncidentalRate("{rateCode}","{rateSubCode}","{internalChargeId}",new UnitNumber({units}),null,context);
