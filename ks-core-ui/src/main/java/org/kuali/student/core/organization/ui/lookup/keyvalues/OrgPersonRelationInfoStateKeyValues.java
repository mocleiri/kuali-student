...
public class OrgPersonRelationInfoStateKeyValues extends UifKeyValuesFinderBase implements Serializable {
    ...
    public List<KeyValue> getKeyValues(ViewModel model) {
        ...
        try {
            List<StateInfo> states = getStateService().getStatesByLifecycle(OrganizationServiceConstants.GENERAL_ORG_PERSON_RELATION_LIFECCYCLE, getContextInfo());
