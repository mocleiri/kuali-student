...
#GRADE ASSESMENTS
  ...
  element(:assessment_notation) { |b| b.checkbox(value: /grade\.completedNotation$/) }
  element(:assessment_a_f) { |b| b.checkbox(value: 'kuali.result.group.grade.letter.plus.minus.standard')}
  element(:assessment_letter) { |b| b.checkbox(value: /grade\.letter$/) }
  element(:assessment_pass_fail) { |b| b.checkbox(value: /grade\.passFail$/) }
  element(:assessment_percentage) {|b| b.checkbox(value: /grade\.percentage$/) }
  element(:assessment_satisfactory) {|b| b.checkbox(value: /grade\.satisfactory$/) }
...
#FINAL EXAM
  ...
  element(:final_exam_rationale) { |b| b.text_field(name: /finalExamRationale$/) }
...
#OUTCOME
  ...
  #TODO:: Add the Delete Outcome and Delete buttons when needed for test
