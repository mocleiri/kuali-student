class CreateAcadCalendar < BasePage
  ...
  element(:copy_from_div)  { |b| b.frm.section(id: "KS-AcademicCalendar-CopyPage-From") }
  value(:source_name) { |b| b.frm.div(id: "copyFromAcalName").text }
  value(:source_start_date) { |b| b.frm.div(data_label: "Start Date").text }
  value(:source_end_date) { |b| b.frm.div(data_label: "End Date").text }
