class EditAgenda < BasePage
  ...
  action(:add_btn) { |b| b.frm.button(:text => /Add Rule Statement/).click; b.loading.wait_while_present}
  action(:edit_btn) { |b| b.frm.button(:text => /Edit/).click; b.loading.wait_while_present}
  action(:group_btn) { |b| b.frm.button(:text => /Add Parent/).click; b.loading.wait_while_present}
  action(:update_rule_btn) { |b| b.frm.button(:text => /Update Rule/).click; b.loading.wait_while_present}
  action(:down_btn) { |b| b.frm.button(:text => /Move Down/).click; b.loading.wait_while_present}
  action(:up_btn) { |b| b.frm.button(:text => /Move Up/).click; b.loading.wait_while_present}
  action(:left_btn) { |b| b.frm.button(:text => /Move Left/).click; b.loading.wait_while_present}
  action(:right_btn) { |b| b.frm.button(:text => /Move Right/).click; b.loading.wait_while_present}
  action(:preview_btn) { |b| b.frm.button(:text => /Preview Change/).click; b.loading.wait_while_present}
  action(:copy_btn) { |b| b.frm.button(:text => /Copy/).click; b.loading.wait_while_present}
  action(:cut_btn) { |b| b.frm.button(:text => /Cut/).click; b.loading.wait_while_present}
  action(:paste_btn) { |b| b.frm.button(:text => /Paste/).click; b.loading.wait_while_present}
  action(:del_btn) { |b| b.frm.button(:text => /Delete/).click; b.loading.wait_while_present}
  action(:add_line_btn) { |b| b.frm.button(:text => /add/).click; b.loading.wait_while_present}

  action(:search_link) { |b| b.edit_tree_section.a(:text => /Advanced Search/).click; b.loading.wait_while_present}
