...
public class KSRuleManagementServiceImpl extends RuleRepositoryServiceImpl implements RuleManagementService {
    ...
    private AgendaBoService agendaBoService = new KSAgendaBoServiceImpl();
    private RuleBoService ruleBoService = new KSRuleBoServiceImpl();
...
//        actionBoService.deleteAction(id);
    ...
    public void setBusinessObjectService(final BusinessObjectService businessObjectService) {
        ...
        if (agendaBoService instanceof KSAgendaBoServiceImpl) {
            ((KSAgendaBoServiceImpl) agendaBoService).setBusinessObjectService(businessObjectService);
        }

        if (ruleBoService instanceof KSRuleBoServiceImpl) {
            ((KSRuleBoServiceImpl) ruleBoService).setBusinessObjectService(businessObjectService);
        }
