...
import org.kuali.student.ap.plan.review.ConversationCommenter;
import org.kuali.student.ap.plan.review.ConversationConstants;
import org.kuali.student.ap.plan.review.LearningPlanReviewServiceLocator;
import org.kuali.student.ap.plan.review.LearningPlanReviewStrategy;
import org.kuali.student.ap.plan.review.dto.ConversationAdvisorInfo;
import org.kuali.student.ap.plan.review.dto.ConversationCommenterInfo;
...
public abstract class ConversationControllerBase extends UifControllerBase {
	...
	protected LearningPlanReviewStrategy getLearningPlanReviewStrategy() {
    	if (learningPlanReviewStrategy == null) {
    		learningPlanReviewStrategy = LearningPlanReviewServiceLocator.getLearningPlanReviewStrategy();
    	}
